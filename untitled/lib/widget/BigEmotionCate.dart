...
import 'package:untitled/widget/SmallEmotionCate.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: Center(
          child: Column(
            children: [
              Text("지금 느끼는 기분을 자세히 알려줄래?", style: TextStyle(fontSize: 25, fontWeight: FontWeight.w700),),
              Text("(카테고리를 선택하면 더 자세한 감정을 고를 수 있어!)", style: TextStyle(fontSize: 15),),
              Row(
                children: [
                  Container(
                    ...
                    child: ElevatedButton(
                        onPressed: (){
                          ...
                          Navigator.push(context, MaterialPageRoute(
                              builder: (context) => SmallEmotionCate(choice: choice,),
                              settings: RouteSettings(name: "/SmallEmotionCate")
                          ));
                        },
                        child: Text("긴장되거나\n가슴이 두근 거리는\n느낌"),
