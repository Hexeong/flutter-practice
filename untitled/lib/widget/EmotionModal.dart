          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Container(
                  ...
                  child: Column(
                    children: [
                      Text("지금 느끼는 감정을 자세히 말해줄래?", style: TextStyle(
                          fontSize: 25,
                          fontWeight: FontWeight.w700
                      )),
                      Text("(최대 3개까지 선택 가능)", style: TextStyle(fontSize: 15, color: Colors.black, fontWeight: FontWeight.w400),)
                    ],
                  )
              ),
            ),
          ...
          SliverPadding(
            ...
            sliver: SliverGrid(
              delegate: SliverChildBuilderDelegate(
                    (c, i) => TextButton(
                  child: Text(context.read<EmotionStore>().kind_of_emotion[i], style: TextStyle(fontSize: 20, fontWeight: FontWeight.w400),),
                  onPressed: () {
            ...
            child: Container(
              ...
              child: Center(
                child: OutlinedButton(
                  child: Text("확인", style: TextStyle(fontWeight: FontWeight.w400, fontSize: 25),),
